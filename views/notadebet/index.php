...
if(date('d-m-Y') != $libur['waktu_hari_libur']){
  ...
  $dataContent = Html::a('<i class="glyphicon glyphicon-repeat"></i>', ['index'], ['data-pjax'=>0, 'class'=>'btn btn-default', 'title'=>Yii::t('app', 'Reset Grid')]);
  $dataTemplate = '{view}';
}
if((date('D')=='Sat')||(date('D')=='Sun'))
{
  $dataContent = Html::a('<i class="glyphicon glyphicon-plus"></i>', ['create'], ['data-pjax'=>0, 'class'=>'btn btn-success', 'title'=>Yii::t('app', 'Create Satuan Kerja')])   . ' '.
    Html::a('<i class="glyphicon glyphicon-repeat"></i>', ['index'], ['data-pjax'=>0, 'class'=>'btn btn-default', 'title'=>Yii::t('app', 'Reset Grid')]);
  $dataTemplate = '{view}';
}
...
?>
    ...
    [
      ...
      [
        ...
        'format'=>'raw',
        'content'=>function($model,$key,$index){
          return Html::a('Setujui', ['approve','id' => $model->id_nota_debet], [
